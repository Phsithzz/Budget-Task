      ...
      <div className="m-30 w-150 h-150 bg-[#373A40] rounded-4xl shadow-xl">
        <header className="flex justify-between items-center bg-[#686D76] rounded-t-4xl h-24">
          <button
            type="button"
            onClick={onCancel}
            className="w-24 h-20 rounded-2xl bg-red-400 m-4 text-white font-semibold text-2xl cursor-pointer transition-all ease-in duration-200  hover:bg-green-400 active:bg-green-700"
          >
            Cancel
          </button>
          <h1 className="m-4 text-white font-semibold text-2xl">My Profile</h1>
        </header>
