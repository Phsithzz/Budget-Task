...
const Wallet = ({ onCancel, onSave }) => {
  ...
  return (
    <>
      <div
        className="flex flex-col justify-center items-center w-[650px] h-[400px] transition ease-in duration-500 
         cursor-pointer
        ...
        <div className="flex flex-col justify-center items-center  gap-y-2">
          ...
          <div className="flex gap-4 justify-end items-center ">
            <button
              type="button"
              onClick={handleSave}
              className="w-20 h-14 cursor-pointer rounded-xl bg-green-400 font-semibold text-white text-xl hover:bg-green-800 active:bg-green-900"
            >
              Save
            </button>
            ...
            <button
              type="button"
              onClick={onCancel}
              className="w-20 h-14 cursor-pointer rounded-xl bg-red-400 font-semibold text-white text-xl hover:bg-red-800 active:bg-red-900"
            >
              Cancel
            </button>
          </div>
